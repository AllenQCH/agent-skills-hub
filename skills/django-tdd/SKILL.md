---
name: django-tdd
description: 'Use when the user explicitly needs the django-tdd workflow: Django testing strategies with pytest-django, TDD methodology, factory_boy, mocking, coverage, and testing Django REST Framework APIs.'
---
