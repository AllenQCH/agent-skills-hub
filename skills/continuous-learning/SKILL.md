...
description: 'Use when the user explicitly needs the continuous-learning workflow: Automatically extract reusable patterns from Claude Code sessions and save them as learned skills for future use.'
---
