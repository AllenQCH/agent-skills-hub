...
For vague or non-trivial product/engineering requests, run the requirements-analysis gate in `references/requirements-analysis-gate.md` before writing the implementation plan. This avoids the common agent failure mode of analyzing only the happy path, missing edge cases, and producing a plan whose logic does not close back to acceptance criteria.
