...
Script path: `/Users/heytea/Documents/myHeytea/code/agent-skills-hub/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=/Users/heytea/Documents/myHeytea/code/agent-skills-hub/skills/maps/scripts/maps_client.py
```
...
- `references/urban-village-rental-scouting.md` — workflow for scouting 城中村 / 新村 / residential micro-areas near a work or transit anchor, with a Shenzhen North example.
...
```bash
python3 /Users/heytea/Documents/myHeytea/code/agent-skills-hub/skills/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python3 /Users/heytea/Documents/myHeytea/code/agent-skills-hub/skills/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
