...
description: 'Use when the user explicitly needs the django-patterns workflow: Django architecture patterns, REST API design with DRF, ORM best practices, caching, signals, middleware, and production-grade Django apps.'
---
