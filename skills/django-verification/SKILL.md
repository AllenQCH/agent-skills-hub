...
description: 'Use when the user explicitly needs the django-verification workflow: Verification loop for Django projects: migrations, linting, tests with coverage, security scans, and deployment readiness checks before release or PR.'
---
