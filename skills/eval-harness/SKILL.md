---
name: eval-harness
description: 'Use when the user explicitly needs the eval-harness workflow: Formal evaluation framework for Claude Code sessions implementing eval-driven development (EDD) principles'
---
